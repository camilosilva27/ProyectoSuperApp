...
- **No se tocó (decisiones de negocio pendientes):** niveles de una misma tarjeta (Naranja X Inicial/Turbo/Épico, Patagonia Clásica/Plus/Singular, Galicia Eminent), "no acumulables" con la promo de producto, promos limitadas a categorías (Cencopay 25%/40%, empleados públicos de Carrefour), topes mensuales/semanales tratados como por ticket. Segmentos, MasGO, Billeteras Virtuales, "10% todos los medios online", Comunidad Coto y "Modo|BNA" de Día se resolvieron el mismo día (ver el bloque siguiente).
