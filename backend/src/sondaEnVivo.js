 ...
 * resultado ya calculado) y no se le suma tráfico de monitoreo a los 5 supers en cada ping
...
// Aceite de Girasol 1.5 Lts Cocinero — presente en los 5 catálogos locales al momento de
// escribir esto (confirmado 2026-08-11). Si en algún refresco futuro deja de estar en alguno,
// esa fuente puntual va a reportar `ok:false` en la sonda aunque no sea un problema real —
// revisar y cambiar el EAN si eso empieza a pasar seguido.
