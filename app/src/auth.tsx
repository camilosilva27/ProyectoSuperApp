...
function mensajeError(error: unknown): string {
  ...
  // "tiene que tener al menos 8 caracteres" — confuso cuando la contraseña nueva SÍ cumple el
  ...
  if (codigo === 'weak_password' || /password/i.test(bruto)) {
    return 'La contraseña tiene que tener al menos 8 caracteres y una mayúscula.';
  }
